...
# ================================================================ #
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers-1):
        ww = self.params['W'+str(i+1)]
        bb = self.params['b'+str(i+1)]
#         print('type of w ',str(i+1),' is ', type(ww))
#         print('type of w is ', type(self.params['W'+str(i+1)]))
        
        if self.use_batchnorm:
            gamma = self.params['gamma'+str(i+1)]
            beta  = self.params['beta'+str(i+1)]
            bn_params = self.bn_params[i]
            #print( type(gamma), type(beta) , type(bn_params) )
#         else:
#             gamma = None
#             beta = None
...
#             print(ww)
        ...
        x, cache = affine_norm_relu_forward(x,ww,bb, gamma, beta, bn_params, self.use_batchnorm, self.use_dropout, self.dropout_param)
        caches.append(cache)
