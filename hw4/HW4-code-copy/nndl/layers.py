...
def batchnorm_backward(dout, cache):
  ...
  N = 1.0 * dout.shape[0]
  dfdz = dout * cache['gamma']                                    # the dimensions are NxD
  dudx = 1/N                                                      
...
def affine_norm_relu_forward(x, w, b, gamma, beta, bn_param, use_batchnorm, use_dropout, dropout_param):
    bn_cache, do_cache = None, None
    
    # affine layer
    #print(' before the affine forward we have the types ', type(x), 'for x; ', type(w), 'for w; ', type(b), 'for c.')
...
def affine_norm_relu_backward(dout, cache, use_batchnorm, use_dropout):
